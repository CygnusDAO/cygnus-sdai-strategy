...
module.exports = async function Make() {
     ...
     */
    // Set the chain ID
    const chainId = 1; // For 1inch

    // Matic / ETH
    const lpTokenAddress = "0xa9782a2c9c3fb83937f14cdfac9a6d23946c9255";
    ...
    const nativeAddress = "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2";

    // Set the Chainlink aggregator addresses for USDC
    const usdcAggregator = "0xAed0c38402a5d19df6E4c03F4E2DceD6e29c1ee9";

    // Set the chainlink aggregator addresses for the LP token's assets (token0/token1)
    const aggregators = ["0x8fFfFfd4AfB6115b954Bd326cbe7B4BA576818f6", "0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419"];
    ...
    await registry.createNebulaOracle(0, lpTokenAddress, aggregators, false);
    ...
    const factory = await Factory.deploy(usdcAddress, nativeAddress, registry.address);
    ...
    await factory.setDaoReserves(reserves.address);
    ...
    const RouterX = await ethers.getContractFactory("XHypervisor");
