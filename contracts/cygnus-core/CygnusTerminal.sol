...
abstract contract CygnusTerminal is ICygnusTerminal, ERC20, ReentrancyGuard {
    ...
    function _convertToShares(uint256 assets) internal view returns (uint256) {
        ...
        return _totalSupply == 0 ? assets : assets.fullMulDivUp(_totalSupply, totalAssets());
    }
    ...
    function _convertToAssets(uint256 shares) internal view returns (uint256) {
        ...
        // Compute assets given an amount of CygUSD or CygLP shares, rounding up
        return _totalSupply == 0 ? shares : shares.fullMulDivUp(totalAssets(), _totalSupply);
    }
    ...
    function _previewTotalBalance() internal virtual returns (uint256 balance) {
        // Check balance of underlying we own
